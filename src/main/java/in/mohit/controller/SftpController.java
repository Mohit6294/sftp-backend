...
public class SftpController {
	...
	public ResponseEntity<FileModal> uploadFile(MultipartFile file, @RequestParam(value = "directory"
        ...
        try {
			return ResponseEntity.status(HttpStatus.CREATED).body(sftpService.uploadFile(directory, file.getOriginalFilename(), file.getInputStream(),file.getSize()));
        } catch (IOException e) {
